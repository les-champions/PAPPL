...
ProcessPtr* GProcess::getProcess() {
    return &(this->process);
}

ProcessPtr GProcess::getProcessPtr() {
    return this->process;
}
...
QGraphicsRectItem* GProcess::getMarginRect() {
    return this->marginRect;
}

QPointF* GProcess::getCenterPoint() {
    return this->center;
}

QSizeF* GProcess::getSizeEllipse() {
    return this->size;
}

QGraphicsTextItem* GProcess::getText() {
    return this->text;
}

bool GProcess::getProcessActifState() {
    return this->actifState;
}

int GProcess::getProcessColorNumber() {
    return this->numberProcessColor;
}
