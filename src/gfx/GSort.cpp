...
// getters
vector <GProcessPtr> GSort:: getGProcesses() {
    return this->gProcesses;
}
...
GVNode GSort::getNode() {
    return this->node;
}

QGraphicsTextItem* GSort::getText() {
    return this->text;
}

QPoint GSort::geteventPressPoint() {
    return this->eventPressPoint;
}

QPointF* GSort::getLeftTopCornerPoint() {
