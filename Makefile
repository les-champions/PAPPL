...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Fri Feb 21 22:07:19 2014
# Project:  pappl.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/pappl1.0.0/ && $(COPY_FILE) --parents headers/Action.h headers/Exceptions.h headers/IO.h headers/GProcess.h headers/GAction.h headers/GSort.h headers/GVEdge.h headers/GVNode.h headers/MainWindow.h headers/MyArea.h headers/PH.h headers/PHScene.h headers/PHIO.h headers/Process.h headers/Sort.h headers/Area.h headers/TextArea.h headers/TreeArea.h headers/ColorerSequences.h headers/ConnectionSettings.h headers/ArgumentFrame.h headers/FuncFrame.h headers/FunctionForm.h headers/test/ChoixLigne.h headers/GVSkeletonGraph.h headers/EditorSettings.h headers/EditorOptions.h .tmp/pappl1.0.0/ && $(COPY_FILE) --parents src/gfx/GProcess.cpp src/gfx/GAction.cpp src/gfx/GSort.cpp src/gfx/PHScene.cpp src/gviz/GVSkeletonGraph.cpp src/io/IO.cpp src/io/PHIO.cpp src/ph/Action.cpp src/ph/PH.cpp src/ph/Process.cpp src/ph/Sort.cpp src/ui/MainWindow.cpp src/ui/MyArea.cpp src/ui/TextArea.cpp src/ui/TreeArea.cpp src/ui/Area.cpp src/ui/ColorerSequences.cpp src/ui/ConnectionSettings.cpp src/ui/ArgumentFrame.cpp src/ui/FuncFrame.cpp src/ui/FunctionForm.cpp src/ui/ChoixLigne.cpp src/ui/EditorSettings.cpp src/ui/EditorOptions.cpp src/Main.cpp .tmp/pappl1.0.0/ && (cd `dirname .tmp/pappl1.0.0` && $(TAR) pappl1.0.0.tar pappl1.0.0 && $(COMPRESS) pappl1.0.0.tar) && $(MOVE) `dirname .tmp/pappl1.0.0`/pappl1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/pappl1.0.0
...
compiler_moc_header_make_all: moc_MainWindow.cpp moc_MyArea.cpp moc_Area.cpp moc_TextArea.cpp moc_TreeArea.cpp moc_ColorerSequences.cpp moc_ConnectionSettings.cpp moc_FunctionForm.cpp moc_EditorSettings.cpp moc_EditorOptions.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_MainWindow.cpp moc_MyArea.cpp moc_Area.cpp moc_TextArea.cpp moc_TreeArea.cpp moc_ColorerSequences.cpp moc_ConnectionSettings.cpp moc_FunctionForm.cpp moc_EditorSettings.cpp moc_EditorOptions.cpp
...
moc_EditorOptions.cpp: headers/GAction.h \
		headers/GVEdge.h \
		headers/PHScene.h \
		headers/Action.h \
		headers/PH.h \
	...
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) headers/EditorOptions.h -o moc_EditorOptions.cpp
...
.tmp/EditorOptions.o: src/ui/EditorOptions.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .tmp/EditorOptions.o src/ui/EditorOptions.cpp
...
.tmp/moc_EditorOptions.o: moc_EditorOptions.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .tmp/moc_EditorOptions.o moc_EditorOptions.cpp
