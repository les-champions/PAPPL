...
template<class T>
struct r_lit_traits<T, true> {
    typedef r_bin_t<T> type;
};

template<>
struct r_lit_traits<char> {
    typedef r_char_t<char> type;
};

template<>
struct r_lit_traits<wchar_t> {
    typedef r_char_t<wchar_t> type;
};

template<>
struct r_lit_traits<const char*> {
    typedef r_str_t<char> type;
};

template<>
struct r_lit_traits<const wchar_t*> {
    typedef r_str_t<wchar_t> type;
};
...
typename std::enable_if<!is_rule<typename std::remove_reference<BoolT>::type>::value,
         ...
         >
r_bool (BoolT&& b) {
    return r_bool_t<BoolT>(std::forward<BoolT>(b));
}

//-------------------------------------------------------------------------
/// r_empty rule matches anything and doesn't advance iterator
//-------------------------------------------------------------------------
inline r_empty_t r_empty () {
    return r_empty_t();
}
...
>
r_bin (T&& t) {
    return r_bin_t<T>(std::forward<T>(t));
}
...
r_lit (T t) {
    return static_cast<typename detail::r_lit_traits<T>::type>(t);
}
...
//-------------------------------------------------------------------------
template<class Pred>
r_pred_t<Pred> r_pred (Pred&& pred) {
    return r_pred_t<Pred>(std::forward<Pred>(pred));
}
...
//-------------------------------------------------------------------------
template<class Pred>
r_predstr_t<Pred> r_predstr (Pred&& pred) {
    return r_predstr_t<Pred>(std::forward<Pred>(pred));
}
...
r_array_t<T, N> r_array (std::array<T, N>& a) {
    return r_array_t<T, N>(a);
}
...
//-------------------------------------------------------------------------
inline r_pred_t<is_alpha> r_alpha() {
    return r_pred(is_alpha());
}

//-------------------------------------------------------------------------
/// r_alphastr rule marches a string of alpha characters
//-------------------------------------------------------------------------
inline r_predstr_t<is_alpha> r_alphastr() {
    return r_predstr(is_alpha());
}
...
//-------------------------------------------------------------------------
inline r_pred_t<is_num> r_num() {
    return r_pred(is_num());
}

//-------------------------------------------------------------------------
/// r_numstr rule matches a string of numeric characters
//-------------------------------------------------------------------------
inline r_predstr_t<is_num> r_numstr() {
    return r_predstr(is_num());
}
...
//-------------------------------------------------------------------------
inline r_pred_t<is_alnum> r_alnum() {
    return r_pred(is_alnum());
}

//-------------------------------------------------------------------------
/// r_alnumstr matches a string of alpha-numeric characters
//-------------------------------------------------------------------------
inline r_predstr_t<is_alnum> r_alnumstr() {
    return r_predstr(is_alnum());
}
...
//-------------------------------------------------------------------------
inline r_pred_t<is_oct> r_oct() {
    return r_pred(is_oct());
}

//-------------------------------------------------------------------------
/// r_octstr rule matches a string of octadecimal characters
//-------------------------------------------------------------------------
inline r_predstr_t<is_oct> r_octstr() {
    return r_predstr(is_oct());
}
...
//-------------------------------------------------------------------------
inline r_pred_t<is_hex> r_hex() {
    return r_pred(is_hex());
}

//-------------------------------------------------------------------------
/// r_hexstr rule matches a string of hexadecimal characters
//-------------------------------------------------------------------------
inline r_predstr_t<is_hex> r_hexstr() {
    return r_predstr(is_hex());
}
...
//-------------------------------------------------------------------------
inline r_pred_t<is_bin> r_binary() {
    return r_pred(is_bin());
}

//-------------------------------------------------------------------------
/// r_hexstr rule matches a string of hexadecimal characters
//-------------------------------------------------------------------------
inline r_predstr_t<is_bin> r_binstr() {
    return r_predstr(is_bin());
}
...
//-------------------------------------------------------------------------
inline r_pred_t<is_printable> r_printable() {
    return r_pred(is_printable());
}

//-------------------------------------------------------------------------
/// r_printablestr rule matches a string of printable characters
//-------------------------------------------------------------------------
inline r_predstr_t<is_printable> r_printablestr() {
    return r_predstr(is_printable());
}
...
//-------------------------------------------------------------------------
inline r_pred_t<is_any_t<void>> r_any() {
    return r_pred(is_any_t<void>());
}
